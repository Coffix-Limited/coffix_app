...
<html lang="en">
  ...
  <body style="margin:0;padding:32px 0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
    <table width="900" align="center" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;border:none;border-collapse:collapse;">
      ...
      <tr>
        <td style="padding:8px 48px 48px;color:#1a1a1a;font-size:14px;line-height:1.6;">
          ${content}
        </td>
      </tr>
      <tr>

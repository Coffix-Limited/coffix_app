export const orderCoffixCreditTemplate = `<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Your Coffix Credit Claim</title>
    <style>
      body {
        margin: 0;
        padding: 0;
  ...
  <body>
    <div class="wrapper">
      ...
      <div class="tax-invoice-header">
        <p class="tax-invoice-number">Coffix Credit Claim: {{transactionNumber}}</p>
      </div>
